...
const navItems = [['About Me', 'AboutMe'], ['Projects', 'projects'], ['Contact', 'contact']];
...
function Navigation({parentToChild, modeChange}: any) {
  ...
  const scrollToSection = (section: string) => {
    ...
    if (AboutMeElement) {
      ...
      console.error('Element with id "AboutMe" not found');  // Debugging: Log error if element is not found
    }
  };
